...
/**
 * https://muyangmin.github.io/glide-docs-cn/doc/getting-started.html 详细doc
 */
/**
 * Glide的加载流程可以概括为以下流程：
 *
...
/**
 * glide with 初始化glide配置，缓存配置(缓存大小，内存缓存，磁盘缓存)，生命周期的绑定（当前添加一个fragment，使用ActivityFragmentLifecycle注入监听），
